...
vim.keymap.set('n', '<leader>5', '<cmd>colorscheme vim<CR>')
vim.keymap.set('n', '<leader>6', '<cmd>colorscheme industry<CR>')
vim.keymap.set('n', '<leader>7', '<cmd>colorscheme elflord<CR>')
